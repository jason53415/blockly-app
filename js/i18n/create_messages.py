...
def main():
  ...
  parser.add_argument('--output_dir', default='block_msg/',
                      help='relative directory for output files')
  parser.add_argument('--mlgame_dir', default='mlgame/',
                      help='relative directory for output files')
  parser.add_argument('--mlgame_output_dir', default='game_msg/',
                      help='relative directory for output files')                      
  ...
  for mlgame_file in mlgame_files:
    ...
    if os.path.isfile(outname):
      ...
      print("FAILED to create " + outname)
